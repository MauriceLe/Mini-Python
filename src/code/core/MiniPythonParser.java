...
public class MiniPythonParser extends Parser {
	...
	public static final int
		...
		EQUAL=15, NOT_EQUAL=16, FROM=17, IMPORT=18, IF=19, ELIF=20, ELSE=21, WHILE=22, 
		RETURN=23, CLASS_=24, DEF=25, SELF=26, TRY=27, EXCEPT=28, FINALLY=29, 
		ZERO_DIVIS_ERROR=30, NAME_ERROR=31, IMPORT_ERROR=32, LBRACKET=33, RBRACKET=34, 
		ASSIGN=35, COLON=36, DOT=37, COMMA=38, END=39, WS=40, ID=41;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'-'", "'<'", "'>'", "'<='", "'>='", "'=='", "'!='", "'from'", "'import'", 
			"'if'", "'elif'", "'else'", "'while'", "'return'", "'class'", "'def'", 
			"'self'", "'try'", "'except'", "'finally'", "'ZeroDivisionError'", "'NameError'", 
			"'ImportError'", "'('", "')'", "'='", "':'", "'.'", "','"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"NOT_EQUAL", "FROM", "IMPORT", "IF", "ELIF", "ELSE", "WHILE", "RETURN", 
			"CLASS_", "DEF", "SELF", "TRY", "EXCEPT", "FINALLY", "ZERO_DIVIS_ERROR", 
			"NAME_ERROR", "IMPORT_ERROR", "LBRACKET", "RBRACKET", "ASSIGN", "COLON", 
			"DOT", "COMMA", "END", "WS", "ID"
		};
	}
