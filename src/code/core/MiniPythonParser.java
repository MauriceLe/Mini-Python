...
public class MiniPythonParser extends Parser {
	...
	public static final int
		...
		ZERO_DIVIS_ERROR=29, VALUE_ERROR=30, ASSIGN_ERROR=31, LBRACKET=32, RBRACKET=33, 
	...
	public static final int
		...
		RULE_elif_statement = 12, RULE_else_statement = 13, RULE_import_module = 14, 
		RULE_exception = 15, RULE_try = 16, RULE_try_statement = 17, RULE_exc_statement = 18, 
		RULE_fin_statement = 19, RULE_call = 20, RULE_fun_parameter = 21, RULE_function = 22, 
		RULE_class = 23;
	private static String[] makeRuleNames() {
		return new String[] {
			"start", "expression", "statement", "statements", "identifier", "assignment", 
			"condition", "exp_parameter", "return", "while", "if", "if_statement", 
			"elif_statement", "else_statement", "import_module", "exception", "try", 
			"try_statement", "exc_statement", "fin_statement", "call", "fun_parameter", 
			"function", "class"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'try'", "'except'", "'finally'", "'ZeroDivisionError'", "'ValueError'", 
			"'AssignError'", "'('", "')'", "'='", "':'", "'.'", "','"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"DEF", "SELF", "TRY", "EXCEPT", "FINALLY", "ZERO_DIVIS_ERROR", "VALUE_ERROR", 
			"ASSIGN_ERROR", "LBRACKET", "RBRACKET", "ASSIGN", "COLON", "DOT", "COMMA", 
			"END", "WS", "ID"
		};
	}
	...
	public final Import_moduleContext import_module() throws RecognitionException {
		...
		enterRule(_localctx, 28, RULE_import_module);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(171);
	...
	@SuppressWarnings("CheckReturnValue")
	public static class AssignErrorContext extends ExceptionContext {
		public TerminalNode ASSIGN_ERROR() { return getToken(MiniPythonParser.ASSIGN_ERROR, 0); }
		public AssignErrorContext(ExceptionContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof MiniPythonListener ) ((MiniPythonListener)listener).enterAssignError(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof MiniPythonListener ) ((MiniPythonListener)listener).exitAssignError(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MiniPythonVisitor ) return ((MiniPythonVisitor<? extends T>)visitor).visitAssignError(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	public static class ValueErrorContext extends ExceptionContext {
		public TerminalNode VALUE_ERROR() { return getToken(MiniPythonParser.VALUE_ERROR, 0); }
		public ValueErrorContext(ExceptionContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof MiniPythonListener ) ((MiniPythonListener)listener).enterValueError(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof MiniPythonListener ) ((MiniPythonListener)listener).exitValueError(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MiniPythonVisitor ) return ((MiniPythonVisitor<? extends T>)visitor).visitValueError(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	...
	public final ExceptionContext exception() throws RecognitionException {
		...
		try {
			...
			case ZERO_DIVIS_ERROR:
				...
				break;
			case VALUE_ERROR:
				_localctx = new ValueErrorContext(_localctx);
				enterOuterAlt(_localctx, 2);
				{
				setState(175);
				match(VALUE_ERROR);
				...
				break;
			case ASSIGN_ERROR:
				_localctx = new AssignErrorContext(_localctx);
				enterOuterAlt(_localctx, 3);
				{
				setState(176);
				match(ASSIGN_ERROR);
	...
	public final TryContext try_() throws RecognitionException {
		...
		enterRule(_localctx, 32, RULE_try);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Try_statementContext try_statement() throws RecognitionException {
		...
		enterRule(_localctx, 34, RULE_try_statement);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 1099610587166L) != 0) {
				{
				{
				setState(188);
				statements();
	...
	public final Exc_statementContext exc_statement() throws RecognitionException {
		...
		enterRule(_localctx, 36, RULE_exc_statement);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Fin_statementContext fin_statement() throws RecognitionException {
		...
		enterRule(_localctx, 38, RULE_fin_statement);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Fun_parameterContext fun_parameter() throws RecognitionException {
		...
		enterRule(_localctx, 42, RULE_fun_parameter);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
