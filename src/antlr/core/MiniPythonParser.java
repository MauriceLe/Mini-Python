...
public class MiniPythonParser extends Parser {
	...
	public static final int
		...
		RETURN=23, CLASS_=24, DEF=25, TRY=26, EXCEPT=27, FINALLY=28, ZERO_DIVIS_ERROR=29, 
		NAME_ERROR=30, IMPORT_ERROR=31, LBRACKET=32, RBRACKET=33, ASSIGN=34, COLON=35, 
		DOT=36, COMMA=37, END=38, WS=39, ID=40;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"CLASS_", "DEF", "TRY", "EXCEPT", "FINALLY", "ZERO_DIVIS_ERROR", "NAME_ERROR", 
